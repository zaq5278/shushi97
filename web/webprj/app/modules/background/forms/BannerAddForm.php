...
class BannerAddForm extends CustomForm
{
    public function initialize($entity = null, $options = null)
    {
        ...
        $itemSelects = new Select("param1",$entity->intrDatas[0]);
        $itemSelects->setLabel("商品编号");
        //$itemSelects->setDefault($entity->name['intrDatas'][2]);
        $this->add($itemSelects);

        $itemSelectss = new Select('param2',$entity->goods_Datas[0]);
        $itemSelectss->setLabel("商品编号");
        //$itemSelectss->setDefault($entity['goods_Datas']);
