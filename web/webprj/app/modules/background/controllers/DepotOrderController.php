 ...
 */
class DepotOrderController extends BaseController
{
    public function initialize()
    {
        parent::initialize(); // TODO: Change the autogenerated stub
        $menu = $this->menu;
        $menu['depotorder']['link_action'] = "";
        $menu['depotorder']['active'] = true;
        $this->view->menu_root = $menu;
        $this->view->nav_menu = array_merge(array($this->view->nav_menu, array("name" => "订单管理", "link" => "admin/DepotOrder")));
        $this->assets->addCss('public/static/background/css/common.css');
    }

    public function indexAction()
    {
        $this->response->redirect("admin/depotorder/search");
    }
...
//        $params = $this->request->getQuery();
        ...
        $queryArray['page'] = "";
        $page_pagination = [
            "url" => $this->url->get("admin/DepotOrder/search?" . http_build_query($queryArray)),
            "cur" => $pagination_cur,
            "total" => $total,
