...
//                  $sHtml.= "<input type='text' name='".$key."' value='".$val."'/>";
                    if($key==='body' || $key==='out_trade_no' || $key==='subject' || $key==='total_fee'){
                        $sHtml.= "<input style='display:none' type='text' name='".$key."' value='".$val."'/><br>";
                    }
                    else{
                        $sHtml.= "<input style='display:none' type='hidden' name='".$key."' value='".$val."'/>";
                    }
                }
